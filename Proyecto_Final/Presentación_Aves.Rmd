...
PC1 - Primer Componente Principal (71.25% de varianza)

* bio_01:   0.558  (contribución positiva)

* bio_07:  -0.572  (contribución negativa)  

* bio_12:   0.600  (contribución positiva)

Interpretación: PC1 representa un gradiente climático general donde:
Valores altos de PC1 = Mayor temperatura anual (bio_01) + Mayor precipitación anual (bio_12) + Menor rango de temperatura (bio_07)
Valores bajos de PC1 = Menor temperatura y precipitación + Mayor rango de temperatura

PC2 - Segundo Componente Principal (16.89% de varianza)

* bio_01:  -0.766  (contribución negativa fuerte)

* bio_07:  -0.633  (contribución negativa)

* bio_12:   0.109  (contribución muy baja)

Interpretación: PC2 representa principalmente un contraste térmico:
Valores altos de PC2 = Temperaturas más bajas (bio_01 negativo)
Valores bajos de PC2 = Temperaturas más altas + Mayor rango térmico

PC3 - Tercer Componente Principal (11.86% de varianza)

* bio_01:  -0.318

* bio_07:   0.521

* bio_12:   0.792  (contribución muy fuerte)

Interpretación: PC3 está dominado por la precipitación (bio_12)
...
* PC1: 1.4620, Mayor variabilidad capturada

* PC2: 0.7118, Menor variabilidad que PC1

* PC3: 0.5965, Menor variabilidad de los tres componentes

Proportion of Variance (Proporción de varianza)

* PC1: 0.7125, Explica más del 71% de la variabilidad total

* PC2: 0.1689, Explica casi el 17% de la variabilidad

* PC3: 0.1186, Explica casi el 12% de la variabilidad

Cumulative Proportion (Proporción acumulada)

* PC1: 0.7125, Captura el 71.25%

* PC1+PC2: 0.8814, Juntos explican el 88.14% de la variabilidad

* PC1+PC2+PC3: 1.0000, Los tres componentes explican el 100%
